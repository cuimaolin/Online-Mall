...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    /**
     * 用户配置需要拦截的url路径，jwt过滤器及出异常后的处理器
     * @param httpSecurity
     * @throws Exception
     */
    @Override
...
//                .permitAll()
    ...
    /**
     * Spring Security定义的用于对密码进行编码及比对的接口，目前使用的是BCryptPasswordEncoder
    ...
    /**
     * SpringSecurity定义的核心接口，用户根据用户名获取用户信息，需要自行实现
     * @return
     */
    @Bean
    ...
    /**
     * 在用户名和密码校验钱添加的过滤器，如果有jwt得token，会自动根据token信息进行登录
     * @return
     * @throws Exception
     */
    @Bean
